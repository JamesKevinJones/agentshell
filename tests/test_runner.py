"""run_backend against real child processes (python itself), never an agent CLI."""
import sys
import unittest
...
class RunBackend(unittest.TestCase):
    def test_captures_stdout_stderr_and_exit_code(self):
        out = run_backend([PY, "-c", "import sys; print('out'); print('err', file=sys.stderr); sys.exit(3)"], HERE)
